...
export const ExperienceData = [
  { year: 'Garmin', date: 'May 2021 - present', text: 'I am currently working as a Web Development Intern, designing UIs and developing API endpoints using Java, JavaScript, HTML/CSS, JQuery, and SQL', },
  { year: 'Nelnet', date: 'Aug 2020 - May 2021', text: 'Engineered a new developer portal web application to display documentation using React, Gatsby, and GraphQL as part of the UNL Raike’s Design Studio', },
  { year: 'Tigerpaw Software', date:'May 2019 - Aug 2020', text: 'Worked as a Software Engineer Intern using C#, VB.NET, and VB6, with a SQL database. On their web application, I worked in Angular and C#', },
  { year: 'Platinum Pro Services', date:'May 2020 - Jun 2020', text: 'Contracted to build a professional services website for a local cleaning company, used for recruitment and advertisement', },
];

export const AccomplishmentData = [
  { number: 5, text: 'Internships/coding jobs', },
  { number: 3.88, text: 'Cumulative GPA'},
  { number: 2, text: 'Minors: Math and Business', },
  { number: 2, text: 'Club Vice President roles', }
];